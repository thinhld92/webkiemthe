...
$stmt = $db->prepare('SELECT catID,catTitle,catSlug FROM blog_cats WHERE catSlug = :catSlug');
					...
					<header>
						<div class="header">
							<nav class="nav container">
								<a href="index.html"><img src="static/assets/imgs/logo.png?v=1" alt="Hồi ức VLTK" class="nav__logo"></a>
								<div class="nav__menu">
									<ul class="nav__list">
