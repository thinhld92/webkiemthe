...
<head>
	...
	<title><?php echo $title_web; ?> - Võ Lâm Truyền Kỳ 2005 , Phiên Bản Công Thành Chiến </title>    
	...
	<!-- Swiper -->
	<script src='static/assets/js/main.js?v=123235'></script>
  ...
  gtag('config', 'G-KRXNM4Y3GG');
	...
	<script>
		...
		{if(f.fbq)return;n=f.fbq=function(){n.callMethod?
			...
			fbq('init', '221574261922586');
			fbq('track', 'PageView');
		</script>
		<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=221574261922586&amp;ev=PageView&amp;noscript=1"
			/></noscript>
			<!-- End Facebook Pixel Code -->
		</head>
		<body class="wrapper-body">
			<div id="fb-root"></div><script>(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) return;  js = d.createElement(s); js.id = id;  js.src = '../connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.0';  fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script>
					...
					<header>
						<div class="header">
							<nav class="nav container">
								<a href="index.html"><img src="static/assets/imgs/logo.png?v=1" alt="Võ Lâm Cổ Truyền" class="nav__logo"></a>
								<div class="nav__menu">
									<ul class="nav__list">
										<li class="nav__item"><a href="index.html" target="_self">Trang chủ </a></li>
								...
								<div class="nav__menu-mobile">
									<div class="menu__mobile-content">
										<div class="menu__mobile-item">
											<a href="index.html"><img src="static/assets/imgs/logo.png?v=1" alt="abc" class="nav__logo-mobile"></a>
										</div>
										<div class="menu__mobile-item btn-list">
								<!-- <a href="#" target="_blank" class="btn btn-download"><span>Tải game</span></a>-->
