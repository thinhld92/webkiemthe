								...
								<table class="footable table table-stripped toggle-arrow-tiny">
									...
									<tbody>
										...
										try {
											...
											$stmt = $db->query('SELECT * FROM blog_logo ORDER BY logo_Id DESC');
											while($row = $stmt->fetch()){
												...
												?>
												<tr>
													<td><button class="btn btn-lg btn-info" type="button"><?php echo $row['logo_Ten']; ?></button></td>
													<td><button class="btn btn-lg btn-primary" type="button"><?php echo $row['logo_Link']; ?></button></td>
													<td><img width="315" height="107" src="<?php echo $url; ?><?php echo $row['logo_Img']; ?>"></td>
													<td><a href="edit-logo.php?id=<?php echo $row['logo_Id'];?>"><button class="btn btn-info " type="button"><i class="fa fa-paste"></i> Edit</button></a> 
