	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    ...
		    $pagination.= "<span class='first disabled'>« </span>";   
		...
		if ($counter == $this->_page)
		    ...
		    $pagination.= "<li class='active'> <a href='".$path."$this->_instance=$counter"."$ext'>$counter</a></li></li>";
		else
		...
		if ($counter == $this->_page)
		    ...
		    $pagination.= "<a href='".$path."$this->_instance=$lastpage"."$ext'>$lastpage</a></li>";       
		}
		...
		if ($this->_page < $counter - 1)
		    ...
		    $pagination.= "<span class='last'> »</span>";
		    $pagination.= "</div>\n";       
		}
